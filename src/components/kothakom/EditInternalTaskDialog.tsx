...
interface EditInternalTaskDialogProps {
    task: Task;
}

export default function EditInternalTaskDialog({ task }: EditInternalTaskDialogProps) {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    const taskRef = doc(firestore, 'internal_tasks', task.id);
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>Edit Internal Task</DialogTitle>
          <DialogDescription>
            Make changes to your internal task below.
          </DialogDescription>
        </DialogHeader>
        <div className="py-4">
          <Form {...form}>
